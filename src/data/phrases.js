// PhraseUp expressions database — 91 idioms and proverbs at B2/C1 level.
//
// Each entry has:
//   id            unique numeric id (used in URLs)
//   type          "Idiom" or "Proverb"
//   category      one of CATEGORIES (Courage, Relationships, Communication...)
//   tone          short label describing the emotional register
//   difficulty    "B2" or "C1"
//   emoji         decorative
//   color         category color (matches CAT_COLORS for visual consistency)
//   phrase        the expression itself
//   meaning       short definition
//   when_to_use   context where it fits
//   dialogue      [{ speaker: "A"|"B", line: "..." }, ...]
//   origin        etymology / cultural origin
